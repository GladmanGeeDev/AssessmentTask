    ...
    <div class="wrapper">
        <div class="content shadow-sm">
            ...
            <div class="container main-container" id="main-container">
                ...
                <div class="page-subtitle">Properties</div>
                <div class="row">
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-3 ">
                        <div class="card text-center shadow-sm border-0 mb-4">
                            ...
                            <div class="card-body">
                                <h6 class="template-primary">{{ $property->name}}</h6>
                                <div class="row my-3">
                               
                                    <div class="col-auto align-self-center">
                                        <h6 class="mb-0 font-weight-light">$USD {{ $property->price}}</h6>
                                    </div>
                                </div>
                                <p class="text-template-primary-light small">{{ $property->location}}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
