        ...
        <div class="content shadow-sm">
            ...
            <div class="container main-container" id="main-container">
                ...
                <form action="{{ route('title.create') }}" method="GET">
                    <button type="submit" class="btn btn-primary float-right">Add Title</button>
                </form>
                
    

                <div class="page-subtitle">All Title</div>
                <div class="card mb-4">
                    <div class="card-body">
                        <table class="table table-striped footable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <h6 class="d-inline-block vm">{{ $title->id }}</h6>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.title.edit', $title->id) }}" style="color: white; text-decoration: none; padding: 5px 10px; display: inline-block; background-color: green; border: none; cursor: pointer;">
                                            Edit
                                        </a>
                                        
                                        <form action="{{ route('admin.title.destroy', $title->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
